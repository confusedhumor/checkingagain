    ...
    let result = datas.map((data) => {
        ...
        for (let i = 0; i < arr2.length; i++) {
            ...
            if (check) {
                join += `
          <div data-v-42f27458="">
              <span data-v-42f27458="" style="color: #84bcff;">
                <span data-v-42f27458="" class="li circle-black" style="color: #84bcff;">${arr2[i]}</span>  
              </span>
          </div>`;
            } else {
                join += `
          <div data-v-42f27458="">
            <span data-v-42f27458="" style="color: #84bcff;">${(arr2[i] == 'c') ? "Even" : (arr2[i] == 'l') ? 'Odd' : (arr2[i] == 'b') ? 'Big' : 'Small'}</span>
          </div>
          `;
            }
        }
      ...
      <div data-v-42f27458="" issuenumber="${data.id_product}" addtime="${timerJoin(data.time)}" rowid="1" class="hb">
          <div data-v-42f27458="" class="item c-row">
              <div data-v-42f27458="" class="c-row c-row-between info" style="justify-content: left; gap: 10px;">
              <div data-v-42f27458="" class="issueName2">
                        ${data.bet} 
              ...
              <div data-v-42f27458="" style="text-align: left; width: 100%;">
                  ...
                  <span data-v-42f27458="" class="state ${(data.status == 1) ? 'green' : 'red'}"" 
                        style="display: ${(data.status == 0) ? 'none' : ''};">${(data.status == 1) ? 'Succeed' : 'Failed'}</span><br>
          ...
          <div data-v-42f27458="" class="details display-none">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Period</div>
                  <div data-v-42f27458="">${data.stage}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Purchase Amount</div>
                  <div data-v-42f27458="">₹${data.money}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Quantity</div>
                  <div data-v-42f27458="">${data.amount}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">After Tax Amount</div>
                  <div data-v-42f27458="" class="red" style="border: 0px solid #d0322d !important; border-radius: 4px; padding: 0px !important;">₹${data.price}</div>
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
              ...
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  ...
                  <div data-v-42f27458=""  style="border: 0px solid #d0322d !important; border-radius: 4px; padding: 0px !important;" class="${(data.status == 1) ? 'green' : 'red'}" style="display: ${(data.status == 0) ? 'none' : ''};">${(data.status == 1) ? 'Success' : 'Fail'}</div>
                  <!---->
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
                  <div data-v-42f27458="">Win Or Loss</div>
                  <div data-v-42f27458=""  style="border: 0px solid #d0322d !important; border-radius: 4px; padding: 0px !important;" class="${(data.status == 1) ? 'green' : 'red'}" style="display: ${(data.status == 0) ? 'none' : ''};">${(data.status == 1) ? '+' : '-'} ₹${(data.status == 1) ? data.get : data.price}</div>
                  <!---->
              </div>
              <div data-v-42f27458="" class="detailLi c-row c-row-between c-row-middle">
